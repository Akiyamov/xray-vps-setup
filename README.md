...
- Установит Xray/Marzban/Remnawave на ваш выбор. Для маскировки страницы используется [Conflunce](https://github.com/Jolymmiles/confluence-marzban-home)
...
- name: Setup vps 
  ...
  vars:
    ...
    setup_variant: marzban # marzban, remnawave or xray
...
Скрипт предлагает выбрать между тремя вариантами:
1. **Только Xray** - минимальная установка без веб-панели
2. **Marzban** - популярная панель управления Xray
3. **Remnawave** - современная панель управления на базе Xray-core

### Особенности Remnawave:
- Современный интерфейс
- Поддержка PostgreSQL
- Встроенная система подписок
- Метрики и мониторинг
- API для интеграции

После установки Remnawave:
1. Откройте https://ваш-домен
2. Пройдите мастер первичной настройки
3. Создайте аккаунт администратора
4. Настройте ноды при необходимости

## Добавляем подписку и поддержку Mihomo (только для Marzban)
